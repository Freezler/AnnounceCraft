const PaperAnnouncement = Vue.createApp({
    ...
    data() {
        return {
            ...
            body: "Introducing [PAA, the ultimate solution for crafting polished last-minute announcements effortlessly and efficiently. Designed with simplicity in mind, our app empowers you to deliver professional messages with ease, ensuring you make a lasting impression even when time is of the essence.",
