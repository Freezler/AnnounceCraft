const shoppingList = Vue.createApp({
    ...
    data() {
        return {
            ...
            body: xploring Vue 3 with cdnjs.com for front-end development using regular HTML, CSS, and JavaScript. Excited about potential integration of Tailwind, Vite, and Nuxt 3."",
